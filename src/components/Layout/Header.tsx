        ...
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm z-[9999] flex items-center justify-center p-4">
            <div className="relative w-full max-w-md">
              ...
              <button
                ...
                className="absolute -top-4 -right-4 p-2 bg-slate-800/90 hover:bg-slate-700/90 rounded-full transition-colors text-white hover:text-red-400 shadow-lg z-[10000]"
              >
                <X size={20} />
              </button>
            </div>
